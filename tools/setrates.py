...
r=gql(M,{"m":[{"ownerId":sid,"namespace":"custom","key":"verzendtarieven","type":"json","value":open(__import__("os").path.join(__import__("os").path.dirname(__file__),"rates.json"),encoding="utf-8").read()}]})
